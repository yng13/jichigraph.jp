    ...
    <div :class="sidebarToggle ? 'justify-center' : 'justify-between'"
        ...
        <a href="{{ secure_url('/') }}">
            <span class="logo" :class="sidebarToggle ? 'hidden' : ''">
                ...
                --}}
                <img class="h-12" src="{{ secure_asset('images/logotype.svg') }}" alt="logotype"/>
            </span>
            {{--
            <img class="logo-icon" :class="sidebarToggle ? 'lg:block' : 'hidden'" src="./images/logo/logo-icon.svg"
                 alt="Logo"/>
            --}}
            <img class="h-12 logo-icon" :class="sidebarToggle ? 'lg:block' : 'hidden'" src="{{ secure_asset('images/logo.svg') }}" alt="logo"/>
        </a>
    </div>
    <!-- SIDEBAR HEADER -->
...
{{--
                    ...
                    <!-- Menu Item Forms -->
                    <li>
                        <a href="javascript:void(0)" @click.prevent="selected = (selected === 'Forms' ? '':'Forms')"
                        ...
                        <div class="overflow-hidden transform translate"
                            ...
                            <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'"
                                class="flex flex-col gap-1 mt-2 menu-dropdown pl-9">
                                <li>
                                    <a href="{{ secure_url('/form-elements') }}" class="menu-dropdown-item group"
                    ...
                    <!-- Menu Item Tables -->
                    <li>
                        <a href="javascripv:void(0)" @click.prevent="selected = (selected === 'Tables' ? '':'Tables')"
                           class="menu-item group"
                        ...
                        <div class="overflow-hidden transform translate"
                            ...
                            <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'"
                                class="flex flex-col gap-1 mt-2 menu-dropdown pl-9">
                                <li>
                                    <a href="{{ secure_url('/basic-tables') }}" class="menu-dropdown-item group"
                    ...
                    <!-- Menu Item Pages -->
                    <li>
                        <a href="javascript:void(0)" @click.prevent="selected = (selected === 'Pages' ? '':'Pages')"
                           class="menu-item group"
                        ...
                        <div class="overflow-hidden transform translate"
                            ...
                            <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'"
                                class="flex flex-col gap-1 mt-2 menu-dropdown pl-9">
                                <li>
                                    <a href="{{ secure_url('/blank') }}" class="menu-dropdown-item group"
                                       :class="page === 'blank' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'">
                                        Blank Page
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ secure_url('404') }}" class="menu-dropdown-item group"
...
{{--
            ...
            <div>
                ...
                <ul class="flex flex-col gap-4 mb-6">
                    <!-- Menu Item Charts -->
                    <li>
                        <a href="javascript:void(0)" @click.prevent="selected = (selected === 'Charts' ? '':'Charts')"
                           class="menu-item group"
                        ...
                        <div class="overflow-hidden transform translate"
                            ...
                            <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'"
                                class="flex flex-col gap-1 mt-2 menu-dropdown pl-9">
                                <li>
                                    <a href="{{ secure_url('/line-chart') }}" class="menu-dropdown-item group"
                                       :class="page === 'lineChart' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'">
                                        Line Chart
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ secure_url('/bar-chart') }}" class="menu-dropdown-item group"
                    ...
                    <li>
                        ...
                        <div class="overflow-hidden transform translate"
                            ...
                            <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'"
                                class="flex flex-col gap-1 mt-2 menu-dropdown pl-9">
                                <li>
                                    <a href="{{ secure_url('/signin') }}" class="menu-dropdown-item group"
                                       :class="page === 'signin' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'">
                                        Sign In
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ secure_url('/signup') }}" class="menu-dropdown-item group"
